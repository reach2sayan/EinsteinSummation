...
MAKE_MATMUL_OPT_BENCH(A, 2, 2);
MAKE_MATMUL_OPT_BENCH(B, 3, 3);
MAKE_MATMUL_OPT_BENCH(C, 4, 4);
MAKE_MATMUL_OPT_BENCH(D, 5, 5);
MAKE_MATMUL_OPT_BENCH(E, 6, 6);
MAKE_MATMUL_OPT_BENCH(F, 7, 7);
MAKE_MATMUL_OPT_BENCH(G, 8, 8);
MAKE_MATMUL_OPT_BENCH(H, 9, 9);
MAKE_MATMUL_OPT_BENCH(I, 10, 10);
MAKE_MATMUL_OPT_BENCH(J, 11, 11);
MAKE_MATMUL_OPT_BENCH(K, 12, 12);
